          ...
          <BaseDialog.Popup
            render={
              <m.div
                ...
                className="ox-side-modal bg-raise shadow-modal pointer-events-auto fixed top-0 right-0 bottom-0 z-(--z-side-modal) m-0 flex w-full md:w-lg flex-col justify-between p-0 rounded-none"
              />
            }
          >
